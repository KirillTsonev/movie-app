...
const RateSvg = ({id}) => {
   ...
   L268.879,121.804l-28.012,143.772l-116.798-33.318l96.166,96.166l-50.185,42.236L306.416,507.025z"
				...
				<path
					style={{fill: "#2B3B4E"}}
					d="M232.151,256.86c-0.433-0.433-0.826-0.826-1.162-1.162
   C231.3,256.009,231.696,256.405,232.151,256.86z"
				/>
			</g>
			<path
				style={{fill: "#F9B54C"}}
				d="M273.929,128.805l23.869,55.294c2.827,6.551,9.004,11.038,16.108,11.704l59.964,5.615
...
C244.857,113.086,267.143,113.086,273.929,128.805z"
			...
			<path
				style={{fill: "#F4A200"}}
				d="M373.87,201.416l-59.964-5.615c-7.104-0.665-13.281-5.153-16.108-11.704l-23.869-55.293
...
C397.802,224.208,390.915,203.012,373.87,201.416z"
			...
			<path
				style={{fill: "#FFD15D"}}
				d="M268.422,165.09l16.537,38.31c1.96,4.539,6.239,7.647,11.161,8.109l41.546,3.889
...
C248.279,154.2,263.721,154.2,268.422,165.09z"
			...
			<path
				style={{fill: "#F9B54C"}}
				d="M345.343,239.026c8.904-7.835,4.132-22.521-7.677-23.628l-41.546-3.889
